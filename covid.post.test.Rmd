...
plot.p = function(){
lwd.point = 2
plot(pre.tests,post.tests.6,type='l',xlab="Pre.test: P(dz+)",ylab="Post.test: P(dz+|test-)",lty=1,lwd=lwd.point,main='Post Test Prob given Negative BinaxNOW test in Adult')
...
post.tests.36u = get.post.tests(sens=.45,spec=1)
post.tests.36l = get.post.tests(sens=.27, spec=1)
lines(pre.tests,post.tests.36u,lty=2,col=2)
lines(pre.tests,post.tests.36l,lty=2,col=2)
legend("topleft",
       c(TeX(" P(test+|dz+,sx+)$\\approx$0.64 (0.57,0.71)"),TeX(" P(test+|dz+,sz-)$\\approx$0.36 (0.27,0.45)")),
