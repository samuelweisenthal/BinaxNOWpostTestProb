...
After getting a negative rapid antigen test a few months ago, I tried to use a standard approach to interpret the result.  Namely, I used Bayes rule to calculate post-test probability.  This was not easy, and my interest in the problem has made this an ongoing effort in my free time.  
I recorded my efforts at https://discourse.datamethods.org/t/determining-post-test-probability-of-covid-19/4723/12, and I have tried to collect my most updated thoughts at https://github.com/samuelweisenthal/BinaxNOWpostTestProb/blob/main/covid.post.test.pdf. 
