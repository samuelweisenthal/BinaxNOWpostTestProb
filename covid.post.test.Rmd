...
I am going to show my code to promote transparency and reproducibility.  I have decided finally not however to show the plots in this document.  I am doing this because I am not sure actually that the world will be better off with these plots than without them.  I am not sure if they are usable due to the "trap" mentioned above.  If you want to uncomment this code and see these plots, feel free to do so. [You can find the notebook in my GitHub. You are free to use and modify this code as long as you allow others to use and modify your modification of this code.  Use this code at your own risk, and I will not be responsible for maintenance.]  However, if you do not have training such that it is completely clear to you what was written above about the covariates for the pretest needing to be the same as the covariates for the operating characteristic, I would encourage you not to try to interpret your own test result (I would not try to fix my own furnace, either). This is of course assuming I have been clear and I am not wrong, and it is always possible that I am wrong.
