---
title: "I am at risk, but asymptomatic with a negative rapid test. What is the probability I have coronavirus?"
output:
...
Again use the plot below at your own risk however. If you find
a mistake and want to help make it better, definitely let me know!

To calculate the probability of having the disease given a negative BinaxNOW test, you 
must calculate the likelihood ratio, which depends on sensitivity and specificity.

Hence, here is the likelihood ratio:
