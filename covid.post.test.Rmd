...
## On which bound the marginal should favor
...
In any case, it should be certain that the marginal falls within the conditionals.  It should be certain that the marginal might be closer to one than to another. It is therefore the case that how much you will lose out by constraining yourself to the study covariates depends on your covariates.   
