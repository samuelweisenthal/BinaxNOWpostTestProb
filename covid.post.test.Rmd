...
plot.p(lns,
       ...
       leg.labels=c(TeX("sx+,adult+ (Prince-Guerra)"),
                    TeX("sx-,adult+ (Prince-Geurra)"),"sx null, adult null, (Brummer)"),
...
plot.p(pts,
       ...
       leg.labels=c(TeX("p(dz+|test-,sx+)")," p(dz+|test-)",
                    TeX("p(dz+|test-,sx-)")),
       main="p(dz+|test-,sx+) vs. p(dz+|test-) (simulation)"
       )
